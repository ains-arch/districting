...
# If on remote desktop, change to appropriate file location
...
plt.title("Histogram of Republican Districts by Votes in the 2016 Presidential Election", fontsize=14)
...
plt.xlabel("Republican majority districts", fontsize=12)
plt.ylabel("Ensembles", fontsize=12)
plt.title("Histogram of Republican Districts by Votes in the 2016 Senate Election", fontsize=14)
